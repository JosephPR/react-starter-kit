      ...
      <header className="style-resources">
        {/* <img src="https://media1.giphy.com/media/LpiVeIRgrqVsZJpM5H/giphy.gif?cid=790b76114bfe2f8248992275c69ebe32306f265f484a4a81&rid=giphy.gif" className="App-logo" alt="logo" /> */}
         ...
         <ul>
           ...
           <li><a class="style-links" rel="noopener noreferrer"  target="_blank" href="https://tailwindcss.com/">Tailwind</a></li>
           <li><a class="style-links" rel="noopener noreferrer"  target="_blank" href="https://www.npmjs.com/package/react-burger-menu">React Burger Menu</a></li>
           <li><a class="style-links" rel="noopener noreferrer"  target="_blank" href="https://github.com/JosephPR/react-starter-kit"> Repo link</a></li>
         </ul>
